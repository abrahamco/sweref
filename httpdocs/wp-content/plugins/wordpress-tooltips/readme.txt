...
Wordpress Tooltips support glossary too, screenshot can be found at here https://ps.w.org/wordpress-tooltips/assets/screenshot-6.png.
...
> * Choose whether the tooltip should appear for all matching keyword or only for first matching keywords in the same page
> * Enable/disable Tooltip for images
> * Enable/disable Tooltip for excerpt
> * Enable/disable tooltip in post tags
> * Support tooltip categories
> * Keyword Matching Mode: You can select show tooltips to the first matching tooltip term in the same page or add tooltips effect to all matching keyword in the same page
> * Responsive tooltips, works well in mobile devices
...
> * Enable / disable images in glossary page
...
> * Synonyms, you can enter all synonyms in tooltips editor in one time, and our tooltips plugin will detect all these synonyms and add same tooltips content for these synonyms  
...
> * Customize tooltip box: You can customize the whole stylesheet in customization panel or css file easily, you can set any color, opacity, width, position, show method, hidden method... and so on  for tooltip box.
...
> * Create tooltips Glossary page easily with shortcode [tooltipslist]
...
> * Glossary / Directory / List support multi-language: English, Swedish, German, Frensh, Finnish,Spanish, you can chose your language in optional settings
