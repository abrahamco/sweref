			...
			(
				{
					content:theTipContent,
   					style:
   					{
   						classes:' qtip-dark wordpress-tooltip-free qtip-rounded qtip-shadow <?php echo $toolstipsAnimationClass; ?>'
    				},
    				position:
    				{
				...
				foreach ($tooltsip_synonyms as $tooltsip_synonyms_single)
				{
					...
					else
					{
						if ($onlyFirstKeyword == 'all')
						{
							...
							$content = preg_replace("/(\W)(".$m_keyword.")(?![^<|^\[]*[>|\]])(\W)/is","\\1"."<span class='tooltipsall classtoolTips$m_keyword_id' style='border-bottom:2px dotted #888;'>"."\\2"."</span>"."\\3",$content);
						}
							
						if ($onlyFirstKeyword == 'first')
						{
							$m_keyword = preg_quote($m_keyword,'/');
							$content = preg_replace("/(\W)(".$m_keyword.")(?![^<|^\[]*[>|\]])(\W)/is","\\1"."<span class='tooltipsall classtoolTips$m_keyword_id' style='border-bottom:2px dotted #888;'>"."\\2"."</span>"."\\3",$content,1);
						}
					}
				}
				$content = str_replace($m_single['keyword'], $tooltip_unique_id, $content);
			}
...
span.question, span.questionimage, span.questionexcerpt, span.questiontags,
	span.questionsinglecat, span.hiddenimageinglossary, span.questiontooltippopupanimation {
	cursor: pointer;
...
span.question:hover,span.questionimage:hover, span.questiontags:hover,span.questionsinglecat:hover,span.hiddenimageinglossary:hover, span.questiontooltippopupanimation:hover 
{
...
function upgrade_check()
{
	...
	update_option('ztooltipversion','5.0.5');
}
...
<ul>
<li>										 
* 7 preset tooltips stylesheet, 5 preset glossary beautiful color schemes 
</li>
<li>
* <a class="" target="_blank" href="https://tooltips.org/features-of-wordpress-tooltips-plugin/">Fine-grained options to custom tooltips and glossary:</a> color picker, border, opacity, width, position, shadow, font..., enable / disable tooltips for any specified post types and specified pages, multi trigger methods support click link,video,audio in tooltips, Multi tooltips for Image Mode, glossary pages, glossary terms, glossary style...a lot of more! 
</li>
<li>
*  Tooltips for <a href="https://tooltips.org/product/show-tooltips-in-woocommerce-products/">WooCommerce Product</a>, <a href="https://tooltips.org/add-tooltips-for-table/">Tables</a>, <a href="https://tooltips.org/tooltips-for-pricing-table/" >Pricing Table</a>, <a href="https://tooltips.org/tooltips-for-button/">Buttons</a>, HTML5 FAQ, menu item, posts title, tags...
</li>
<li>
* Responsive, WPML Multilingual, Hit stats, import tooltips, <a href='https://tooltips.org/bullet-screen'>Bullet Screen effects</a> ...more features
</li>
<li>
